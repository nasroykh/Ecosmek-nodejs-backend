...
//      If the account is not an admin account
            ...
            res.send({title: 'Welcome ' + account.fullName + '. I hope you apreciate our shop', signedIn: true, token: token})
...
//  Else If the email and fullname are not used
        ...
        await AccountsF._create_new_account(req.body.fullName, req.body.email, req.body.password)
